...
(function (factory) {
  ...
  L.Control.Search = L.Control.extend({
    ...
    options: {
      ...
      textErr: 'Non trouvé', // error message
      textCancel: 'Supprimer la recherche', // title in cancel button
      textPlaceholder: 'Rechercher par nom de mission...', // placeholder value
